...
class WPCustomNavMenuWidget extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        parent::__construct('custom_nav_menu', __('Custom Navigation Menu'), $widget_ops);
    }
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        if (! empty($new_instance['title_link'])) {
    ...
    public function form($instance)
    {
        ...
        <div class="nav-menu-widget-form-controls" <?php echo $empty_menus_style; ?>>
            ...
            <p>
                ...
                <input type="text" class="widefat" id="<?php echo $this->get_field_id('title_link'); ?>" name="<?php echo $this->get_field_name('title_link'); ?>" value="<?php echo esc_attr($title_link); ?>"/>
            </p>
            <p>
